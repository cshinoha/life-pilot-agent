...
async def cmd_help(message: Message) -> None:
    """Handle /help command."""
    await message.answer(
        "<b>Как использовать Life Pilot:</b>\n\n"
        "1. Отправь голосовое — транскрибирую и сохраню\n"
        "2. Отправь текст — сохраню как есть\n"
        "3. Отправь фото — сохраню в attachments\n"
        "4. Перешли сообщение — сохраню с источником\n\n"
        "Вечером /process — мысли в Obsidian, задачи в Todoist\n\n"
        "<b>📥 Ввод и обработка:</b>\n"
        "✨ /do — произвольный запрос к AI\n"
        "📌 /recall — поиск по записям vault\n"
        "⚙️ /process — обработать записи дня\n\n"
        "<b>📊 Обзор и планирование:</b>\n"
        "📋 /plan — план на сегодня из Todoist\n"
        "📅 /weekly — недельный дайджест\n"
        "📊 /status — сколько записей сегодня\n"
        "/monthly — месячный отчёт\n\n"
        "<b>🧰 Vault инструменты:</b>\n"
        "🏥 /health — тиры памяти + граф связей\n"
        "🧠 /memory — сканирование + конфиг decay\n"
        "🎲 /creative — случайные карточки для вдохновения\n"
        "     <i>/creative 5</i> — указать кол-во (1-10)\n\n"
