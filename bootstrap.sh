...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/VDanchAI/agent-second-brain/main/bootstrap.sh | bash
# =============================================================================
...
SETUP_URL="https://raw.githubusercontent.com/VDanchAI/agent-second-brain/main/setup.sh"
